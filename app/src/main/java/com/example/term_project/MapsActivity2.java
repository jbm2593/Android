...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng Cheonan = new LatLng(36.821751  , 127.147057);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(Cheonan);
        markerOptions.title("천안");
        markerOptions.snippet("천안축구센터");
        mMap.addMarker(markerOptions);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Cheonan));
        mMap.animateCamera(CameraUpdateFactory.zoomTo(17.0f));
        Toast.makeText(MapsActivity2.this, "천안역에 도착하였습니다.", Toast.LENGTH_SHORT).show();
